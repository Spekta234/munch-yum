...
class MFormatException implements Exception{
  ...
  const MFormatException([this.message = 'An unexpected error occurred. Please check your input.']);
  ...
  factory MFormatException.fromCode(String code) {
    switch (code) {
      ...
      case 'invalid-credit-card-format':
        return const MFormatException('The credit card number format is invalid. Please enter a valid credit card number.');
